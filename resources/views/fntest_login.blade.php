    ...
    <div class="publicCustomContent">
        <form method="post" class="publicform signIn">
            ...
            <ul class="content">
                ...
                <li>
                    <input type="text" placeholder="請輸入帳號" name="username" value="{{ old('username')?old('username'):''}}">
                    @error('username')
                        <span class="puplicError">{{ $message }}</span>
                    @enderror
                </li>
                <li>
                    ...
                    <input type="text" placeholder="請輸入密碼" name="password" value="{{ old('password')?old('password'):'' }}">
                    @error('password')
                        <span class="puplicError">{{ $message }}</span>
                    @enderror
                </li>
