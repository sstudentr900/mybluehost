    ...
    <div class="publicCustomContent">
        <form method="post" class="publicform fnforget">
            ...
            <div class="title">
                ...
                <h3>忘記密碼</h3>
                <p>請輸入關於你帳號的電子郵件信箱，認證碼將會寄出。當你收到驗證碼後，你將可以為你的帳號更新密碼。</p>
            </div>
            <ul class="content">
                <li>
                    <input type="text" placeholder="請輸入帳號" name="account" value="{{ old('account')?old('account'):''}}">
                    @error('account')
                        <span class="puplicError">{{ $message }}</span>
                    @enderror
                </li>
                <li><button onclick="showLoad()">送出</button></li>
            </ul>
            <div class="account">
                <p>還沒有帳號?</p><a href="http://10.1.6.249/mybluehost/public/fnregister">我要註冊</a>
            </div>
        </form>
    </div>
@endsection