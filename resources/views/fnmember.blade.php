...
@section('content')
    <div class="publicCustomContent">
        <form method="post" class="publicform signIn">
            {!! csrf_field() !!}
            <div class="title">
            ...
            <ul class="content">
                <li>
                    <input type="text" placeholder="請輸入帳號" name="account" value="{{ old('account')?old('account'):'1@1.1'}}">
                    @error('account')
                ...
                <li>
                    ...
                    <input type="password" placeholder="請輸入密碼" name="password" value="{{ old('password')?old('password'):'1' }}">
                    @error('password')
                        <span class="puplicError">{{ $message }}</span>
                    @enderror
                </li>
                <li>
                    ...
                    <!-- <button onclick="showLoad()">登入</button> -->
                </li>
                <li>
            ...
            <div class="account">
                <p>還沒有帳號?</p><a href="{{ URL::asset('fnregister') }}">我要註冊</a>
            </div>
        </form>
    </div>
@endsection