...
<html lang="zh-tw">
    <head>
        ...
        <link href="{{ asset('css/fnapp.css')}}" rel="stylesheet" type="text/css">
        ...
        <script src="{{ asset('js/fnapp.js')}}"></script>
    </head>
    <body>
        <div class="fn {{ $active }}">
            ...
            <div class="publicSection">
                    ...
                    <div class="nav">
                        ...
                        <div class="menu">
                            <ul>
                                ...
                                <li class="{{ $active == 'fnmeeting_year'?'active':'' }}">
                                    <a href="{{ route('fnmeeting_year')}}">年會研討會</a>
                                </li>
                ...
                <div class="publicMain">
                    <div class="nav">
                        ...
                        <div class="logo">
                            <img src="{{ asset('img/fnlogo.png') }}" alt="">
                        </div>
                    </div>
                    @yield('content')
                </div>
