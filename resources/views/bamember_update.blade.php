                    ...
                    <li>
                        ...
                        <div class="input">
                            <input
                                ...
                                name="url"
                                placeholder="請輸入網址"
                                value="{{ old('url')?old('url'):(!$errors->any() && $datas?$datas->url:'') }}"
                            >
                            @if ($errors->any())
                    ...
                    <li>
                        ...
                        <div class="input">
                            <textarea
                                ...
                                name="describe"
                                placeholder="請輸入描述"
                            >{{ old('describe')?old('describe'):(!$errors->any() && $datas?$datas->describe:'') }}</textarea>
                            @if ($errors->any())
                                @foreach ($errors->get('describe') as $error)
                                    <span class="puplicError">{{ $error }}</span>
                                @endforeach
                            @endif
                        </div>
                                    ...
                                    <div class="publicRadio">
                                        <div class="radio">
                                            <input
                                                ...
                                                name="gender"
                                                value="m"
                                                @if( old('gender') == "m" || $datas && $datas->gender == "m" || $gender && $gender== "m")
                                                    checked
                                                @endif
                                            >
                                            <label for="m">男</label>
