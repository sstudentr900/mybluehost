            ...
            <ul>
                ...
                <li>
                   ...
                   <div class='genderDiv'>
                    ...
                    <!-- <div class="modify">
                        <a href="{{ URL::asset('bamember_update').'/'.$data->id.'/'.$pageStare }}">
                        ...
                        <a href="javascript:tablePassowd('{{ URL::asset('bamember_passord').'/'.$data->id.'/'.$pageStare }}')">
                            <svg viewBox="0 0 24 24">
                        ...
                        <a href="javascript:tableDelet('{{ URL::asset('bamember_delete').'/'.$data->id.'/'.$pageStare }}')">
                            <svg viewBox="0 0 24 24">
